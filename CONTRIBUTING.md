# Contributing to synthetic-population-schema

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
synthetic-population-schema. These guidelines are not strict rules.
...
The synthetic-population-schema team strives to create a
...
- Pull Requests
    ...
    - PRs should be reviewed and merged in a timely fashion by the synthetic-population-schema technical leads
...
[issues]: https://github.com/sierra-moxon/synthetic-population-schema/issues/
[pulls]: https://github.com/sierra-moxon/synthetic-population-schema/pulls/
